...
class Level(object):
    ...
    def draw(self, screen):
        ...
        # Draw the background
        screen.fill(WHITE)
        # my_image = pygame.image.load("Final Project/Resources/800x600.png")
        # screen.blit(my_image, (800, 600))
...
def main():
    ...
    pygame.display.set_caption("Long's Amazing Python Game Extravaganza")
